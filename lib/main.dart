...
import 'package:win95/main_page.dart';
...
class MainScreen extends StatelessWidget {
  ...
  final _divider = const Divider95(height: 20, endIndent: 8, indent: 8);
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  const Button95(child: Text('Disabled')),
                ],
              ),
              const SizedBox(height: 4),
                ...
                builder: (context, value, child) {
                  return Row(
                    ...
                    children: [
                      ...
                      Checkbox95(value: value, label: "Disabled"),
                    ],
                  );
                },
              ),
              ...
              const Padding(
                padding: EdgeInsets.symmetric(horizontal: 8.0),
                child: TextField95(height: 150, maxLines: 10, multiline: true),
              ),
              _buildListView(),
            ],
          ),
            ...
            itemBuilder: (context, index) {
              return Elevation95(
                child: Padding(
                  ...
                  child: Text('Item $index', style: Flutter95.textStyle),
                ),
              );
            },
          ),
...
class ScreenThatCanPop extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Scaffold95(title: 'Screen that can pop', body: Container());
  }
}
